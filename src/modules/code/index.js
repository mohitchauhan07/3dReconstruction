...
const Code=()=>{
    return(
        <section className={"code"}>
              <div className={'navHelper'} id = "CodeSection">
        ...
        <div className={"Container codeContainer"}>
          ...
          <div className={'displayRow codeLinkContainer'}>
              ...
              <a href={"https://github.com/mohitchauhan07/3dReconstruction"} target="_blank" rel="noreferrer"><button className={'btn codeBtn'}>{"Check Code"}</button></a>
          </div>
          </div>
        </div>
      </section>
